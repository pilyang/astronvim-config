...
return {
  ...
  opts = {
    ...
    mappings = {
      ...
      i = {
        ["<C-o>"] = { "<ESC>o", desc = "insert new line below" },
        ["<C-S-o>"] = { "<ESC>O", desc = "insert new line above" },
        ["<C-i>"] = { "<ESC>I", desc = "move cursor to end of line" },
        ["<C-a>"] = { "<ESC>A", desc = "move cursor to start of line" },
      },
      n = {
